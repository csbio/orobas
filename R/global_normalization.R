...
#'  @param condition_control_map_file Path to .tsv file mapping screens to their replicates and earlier time point screens,
#' with three columns 'Screen','Replicates', and 'NormalizeTo' 
#'  @param screen_replicate_map_file Path to .tsv file mapping screens to their controls for scoring, with two 

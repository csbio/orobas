...
#' @param max_reads parameter for \code{normalize_screens}. Maximum number of reads to keep (default -1, if user defines a value anything
...
#'   (default TRUE).
#' @param min_guides parameter for \code{score_controls_batch}. The minimum number of guides per gene pair required to score data (default 3).
#' @param loess parameter for \code{score_controls_batch}. If true, loess-normalizes residuals before running hypothesis testing. (default TRUE).
#' @param ma_transform parameter for \code{score_controls_batch}. If true, M-A transforms data before running loess normalization. Only
#'   has an effect when loess = TRUE (default TRUE).
#' @param control_genes parameter for \code{score_controls_batch}. List of control genes to remove, e.g. "luciferase" (default c("None", "")).
#' @param qc_control_pcc parameter for \code{score_controls_batch}. (default 0.30).
#' @param verbose parameter for \code{score_controls_batch}. If true, prints verbose output (default FALSE). 
#' @param black_list parameter for \code{score_controls_batch}. A list of control screens to be excluded beforehand (default c('bad_screen_name', "")).
#' @param screen_control_keyword parameter for \code{score_controls_batch}. Key words to identify control screen names (default "DMSO|MOCK|Mock|WT|NGLY1|BMI1|Control")
...
#'   below this value will be filtered out).
#' @param max_reads parameter for \code{generate_control_dlfc_scores}. Maximum number of reads to keep (default -1, if user defines a value anything
#'   above the value will be filtered out, otherwise anyything higher than median*20 will be filtered out).
...
#'   with 0's after filtering out T0 guides with too few or NA readcounts 
#'   (default TRUE).
#' @param min_guides parameter for \code{generate_control_dlfc_scores}. The minimum number of guides per gene pair required to score data (default 3).
#' @param loess parameter for \code{generate_control_dlfc_scores}. If true, loess-normalizes residuals before running hypothesis testing. (default TRUE).
#' @param ma_transform parameter for \code{generate_control_dlfc_scores}. If true, M-A transforms data before running loess normalization. Only
#'   has an effect when loess = TRUE (default TRUE).
#' @param control_genes parameter for \code{generate_control_dlfc_scores}. List of control genes to remove, e.g. "luciferase" (default c("None", "")).
#' @param qc_control_pcc parameter for \code{generate_control_dlfc_scores}. (default 0.30).
#' @param verbose parameter for \code{generate_control_dlfc_scores}. If true, prints verbose output (default FALSE). 
#' @param black_list parameter for \code{generate_control_dlfc_scores}. A list of control screens to be excluded beforehand (default c('bad_screen_name', "")).
#' @param screen_control_keyword parameter for \code{generate_control_dlfc_scores}. Key words to identify control screen names (default "DMSO|MOCK|Mock|WT|NGLY1|BMI1|Control")
...
)
{
	...
	#gather scores from various screens from different files generated by the single-screen scoring mode
	all_score <- NULL

...
input_folder = file.path("output","run_6_15_25") # path to folder containing input data (generated by single screen scoring step)
output_folder = file.path("output","run_6_15_25") # path to output folder
